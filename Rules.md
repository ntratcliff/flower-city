...
* Starting with the first player, take turns placing either a leaf or a stem, according to their respective rules (see _Placement Rules_)
...
* Once a **Flower** is placed on an **Offshoot**, no more **Leaves** on that **Offshoot** may be matured. **Leaves** may be matured in the turn between an **Offshoot** maturing and the scoring player placing their **Flower**, but doing so has no affect on the score or scoring player for that **Offshoot**.
